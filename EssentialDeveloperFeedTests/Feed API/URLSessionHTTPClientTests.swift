...
//
//  Created by Fiona Wilson on 10/02/2024.
//
...
final class URLSessionHTTPClientTests: XCTestCase {
    ...
    private func resultValues(forData data: Data?, response: URLResponse?, error: Error?, file: StaticString = #filePath, line: UInt = #line) -> (data: Data, response: HTTPURLResponse)? {
    ...
    private func resultError(forData data: Data?, response: URLResponse?, error: Error?, file: StaticString = #filePath, line: UInt = #line) -> Error? {
    ...
    private func result(forData data: Data?, response: URLResponse?, error: Error?, file: StaticString = #filePath, line: UInt = #line) -> HTTPClientResult {
